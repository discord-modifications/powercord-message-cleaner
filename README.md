...
- Right click context menus to prune messages
- Integrated command system
- Customizable mode (normal & burst)
- Customizable delays for each mode
- Customizable burst size and burst delay
